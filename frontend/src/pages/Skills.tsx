...
const Skills: React.FC = () => {
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 dark:border-gray-700">
        <div className="flex space-x-1">
          ...
          <button
            onClick={() => handleTabChange('top-skills')}
            className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${
            ...
            <div className="animate-fadeIn">
              ...
              <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <p className="text-xs text-gray-700 dark:text-gray-300">
                  💡 <span className="font-semibold">Understanding the numbers:</span> Click any category card to view details. 
                  Percentages show how many jobs require each skill within that category.
                </p>
              </div>
              ...
              <GlassCard hover={false}>
                <div className="p-6">
                  ...
                  <div className="mb-6 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-xs text-gray-700 dark:text-gray-300">
                      💡 <span className="font-semibold">Understanding the numbers:</span> Percentages show how many jobs require each skill. 
                      For example, if Python shows 85%, it means 85% of all tech jobs require Python skills.
                    </p>
                  </div>
                    ...
                    {skills.map((skill, index) => {
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg cursor-pointer border border-gray-200 dark:border-gray-700"
                        >
                          <div className="flex items-center gap-4 flex-1 min-w-0">
                            <span className="text-xl font-bold text-gray-400 dark:text-gray-500 w-8 flex-shrink-0">
                              #{index + 1}
                            </span>
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-gray-600 dark:text-gray-400 truncate">
                                {skill.category?.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}
                              </p>
                            </div>
                          </div>
              ...
              <GlassCard>
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    Enter skills you already know, and we'll recommend what to learn next based on real job market data.
                  </p>
                  ...
                  <div className="mb-6">
                    ...
                    <SkillMultiSelect 
                      ...
                      placeholder="Type to add skills (e.g., Python, SQL, React)"
                    />
                  </div>

                  <button
                    onClick={handleGetRecommendations}
                    disabled={knownSkills.length === 0 || isLoadingRecommendations}
                      ...
                      {recommendations.recommendations && recommendations.recommendations.length > 0 ? (
                        <div className="space-y-3">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-sm text-gray-500 dark:text-gray-400">
                              Based on: {recommendations.known_skills.join(', ')}
                            </span>
                          </div>
                          {recommendations.recommendations.map((rec: any) => (
                            <div 
                              key={rec.skill} 
                              className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer"
                              onClick={() => navigate(`/skills/${rec.skill.toLowerCase().replace(/\s+/g, '-')}`)}
                            >
                              <div className="flex justify-between items-start">
                                <div className="flex-1">
                                  <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 capitalize">
                                    {rec.skill}
                                  </h4>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-amber-800 dark:text-amber-200 mb-3">
                                {recommendations.message || "We couldn't find skills that commonly appear with the ones you entered."}
                              </p>
                ...
                <GlassCard>
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                      Skills that frequently appear together. Percentage shows how many jobs require both skills.
                    </p>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-3 flex-1 min-w-0">
                              <span className="text-sm font-medium text-gray-400 dark:text-gray-500 w-6 flex-shrink-0">
                                {index + 1}
                              </span>
                              <div className="flex items-center gap-2 flex-1 min-w-0">
                                <button
                                  onClick={() => navigate(`/skills/${pair.skill1.toLowerCase().replace(/\s+/g, '-').replace(/\./g, '')}`)}
                                  className="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-md hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors text-xs font-medium capitalize truncate"
                                >
                                  {pair.skill1}
                                </button>
                    ...
                    <div className="mt-6 text-center">
                      <button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-lg transition-all font-medium shadow-md hover:shadow-lg"
                      >
    ...
    {categoryModal && (
      ...
      >
        <div 
          className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-3xl w-full max-h-[85vh] overflow-hidden border border-gray-200 dark:border-gray-700"
        ...
        >
          ...
          <div className="overflow-y-auto max-h-[calc(85vh-80px)] px-6 py-4">
            <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              <p className="text-xs text-gray-700 dark:text-gray-300">
                💡 Percentages show what portion of jobs in this category require each skill. 
                Click on any skill to view detailed analytics.
              </p>
            </div>
              ...
              {categoryModal.skills.map((skill: any, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        <span className="text-sm font-bold text-gray-400 dark:text-gray-500 w-8 flex-shrink-0">
                          #{idx + 1}
                        </span>
            ...
            <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                  <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                    {categoryModal.totalJobs.toLocaleString()}
                  </div>
                    <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                      Total Jobs
                    </div>
